...
file2 = './000 (1)/08-sync-000-LiDAR-PCDs.pkl'
...
plt.plot(df1["Frame"], df1["NumPoints"], marker="o", linestyle="-", linewidth=2, label="Person 1", color="blue")
plt.plot(df2["Frame"], df2["NumPoints"], marker="s", linestyle="--", linewidth=2, label="Person 2", color="red")
...
plt.tight_layout()
plt.savefig("point_counts_comparison.png", dpi=300)  # 儲存成 PNG
plt.show()
